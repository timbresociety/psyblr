  ...
  return (
    <section className="liquid-panel liquid-panel--hidden screen-entrance px-6 py-6 sm:px-8 sm:py-8">
      <div className="flex flex-col gap-5 border-b border-white/40 pb-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-3xl">
            <span className="glass-chip glass-chip--hidden">Hidden player screen</span>
      ...
      <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button type="button" onClick={handleConfirm} disabled={!isSelectionComplete} className="chrome-button w-full sm:w-auto">
          {confirmLabel}
        </button>
      </div>
    </section>
